...
export default function ListingsPage() {
    ...
    const fetchListings = useCallback(async () => {
        ...
        try {
            ...
            console.error('Error fetching listings:', error?.message || error, error?.stack)
    ...
    return (
        <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <form onSubmit={handleSubmit} className="mb-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                <Input
                    name="unit_name"
